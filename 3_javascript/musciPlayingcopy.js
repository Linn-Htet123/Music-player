...
function playListSongBackgroundStart(target) {
   target.classList.toggle("playlist-song-background");
...
album.forEach((album) => {
   album.addEventListener("click", function (e) {
      ...
      const albumCurrentText = this.children[0].children[0].children[1];
      albumArrowBtn.classList.toggle("albumArrowanimation");
      albumCurretnImg.classList.toggle("albumImganimation");
      console.log(albumArrowBtn, albumCurrentText, albumCurretnImg);
   });
});
